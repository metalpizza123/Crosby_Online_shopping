...
<form method="post" action="insertnewuser2.php">
<table>
    <tr><td> <a class='skills'> Username </a> </td><td><input class="form-control" type="text" name="username" value=""></td></tr>
    <tr><td> <a class='skills'> Wallet Value </a></td><td><input class="form-control" type="float" name="initialwallet" value=""></td></tr>
    <tr><td>  <a class='skills'> Password </a> </td><td><input class="form-control" type="text" name="pword" value=""></td></tr>
    </table>
