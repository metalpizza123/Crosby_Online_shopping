...
<body id="page-top" class="index">
    ...
    <section id="contact">
      ...
      <?php
      if (empty($_POST["username"]) or empty($_POST["userwallet"]) or empty($_POST["userpassword"]))
    {
        echo "<a class='skills'>"."Invalid Entry"."</a>
        <form action='edituser2.php'>
        <input type='submit' class='btn btn-success btn-lg' value='Back to edit user page'>
        </form>";
    }
    $UserID=$_POST["UserID"];
...
try { require("connect.php");
    ...
    $sql = "UPDATE Users SET Username='$username', Wallet='$userwallet', Password='$newpassword' where UserID='$UserID'";
    // use exec() because no results are returned
    $conn->exec($sql);
    echo "<a class='skills'>record edited successfully </a>";
    echo " <form action='edituser2.php'>
            <input type='submit'  class='btn btn-success btn-lg' value='back to edit user page'>
            </form>";
    }
