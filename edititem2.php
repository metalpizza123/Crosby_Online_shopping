...
<form action="editproduct2.php">
    <input type="submit"  class="btn btn-success btn-lg" value="back to edit data page">
</form>
<br>
<form method="post" action="adminsplash2.php">
    <input type="submit" class="btn btn-success btn-lg" name="gohome" value="Back to Home Page">
</form>
      <?php
...
try {
   require("connect.php");
    ...
    $conn->exec($sql);
        echo "<p class='skills'>"."Record edited successfully"."</p>" ;
    }
