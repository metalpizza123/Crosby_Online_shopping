...
<body id="page-top" class="index">
    ...
    <section id="contact">
        <div class="container">
            ...
            <!-- ADD A BUTTON TO CHECK OUT AND DEDUCT FROM THEIR WALLET AND CHANGE CONFIRM VALUES -->
                     ...
                     <?php
                     if (empty($_POST["username"]) or empty($_POST["initialwallet"]) or empty($_POST["pword"]))
    {
        echo "<a class='skills'>"."Invalid Entry"."</a>
        <form action='addnewuser2.php'>
        <input type='submit' class='btn btn-success btn-lg' value='back to enter data page'>
        </form>";
    }
    else{
        echo " <form action='addnewuser2.php'>
            <input type='submit'  class='btn btn-success btn-lg' value='back to Add user page'>
            </form>";
   ...
   require("connect.php");
    ...
    $conn->exec($sql);
    echo "<a class='skills'> New User added successfully </a>";
    }
