...
<body id="page-top" class="index">
    ...
    <p class='skills'>> What do you want to edit?</p>
...
<input  class="btn btn-success btn-lg" type="submit" name="refreshtable" value="check item">
    ...
    //isset is a command to check if anything is currently assigned to the variable name
        ...
        echo "<p class='skills'>".$_POST['formproduct']."</p>" ;
           ...
           echo '<br>
           <table>
           <form method="post" action="edititem2.php">
<tr><td> <p class="skills">Product ID </p></td><td><input type="int" name="uniqueid" value="'.$data2['ID'].'" readonly></td></tr>
<tr><td> <p class="skills">Product Name</p></td><td><input type="text" name="pname" value="'.$data2['Name'].'"></td></tr>
<tr><td> <p class="skills">Product Price</p></td><td><input type="int" name="price" value="'.$data2['Price'].'"></td></tr>
<tr><td> <p class="skills">Product Stock</p></td><td><input type="int" name="stock" value="'.$data2['Stock'].'"></td></tr>
</table>
<input class="btn btn-success btn-lg" type="submit" value="Send Data">
</form> ';                               
